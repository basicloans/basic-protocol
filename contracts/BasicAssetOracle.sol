...
contract BasicAssetOracle is ChainlinkAggregatorV3Interface, Ownable {
    using SafeMath for uint;

    uint8 private decimals_;
    string private description_;
    BasicPriceOracle public baseOracle;
    ...
    function setBaseOracle(BasicPriceOracle _baseOracle) external onlyOwner {
        baseOracle = _baseOracle;
    }
}
